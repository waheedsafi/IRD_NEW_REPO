...
class NewsTypeController extends Controller
{
    public function newsTypes()
    {
        ...
        $tr =  NewsType::join()->select("name", 'id', 'created_at as createdAt')->orderBy('id', 'desc')->get();

        NewsType::join("ngo_type_trans", function ($join) use ($locale) {
            // Join Translate table with the related model (e.g., 'destinations') based on translable_id
            $join->on('ngo_type_trans.ngo_type_id', '=', "news_types.id")
