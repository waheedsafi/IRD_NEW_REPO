...
Route::prefix('v1')->middleware(['api.key', "doubleAuthorized:" . 'user:api,ngo:api'])->group(function () {
  ...
  Route::post('/ngo/store/agreement/extend', [AgreementController::class, 'extendNgoAgreement'])->middleware(["userHasSubAddPermission:" . PermissionEnum::ngo->value . "," . SubPermissionEnum::ngo_agreement->value]);
